        ...
        return (
            <LayoutContainer className="components">
                <section>
                    ...
                    <SlideBar label="This one has a custom initial fill percentage of 33%. If you don't specify a percentage, it will default to 50%" initialFillPercent={33} />
                    <SlideBar className='keyo-blue' label="Custom color" initialFillPercent={75} />
                    <SlideBar className='random' label="Go crazy" initialFillPercent={9} />
                </section>
            </LayoutContainer>
        );
    }
